...
const AVATARS = [
  { initial: 'P', bg: '#dbeafe', fg: '#1e40af' },
  { initial: 'M', bg: '#fce7f3', fg: '#9d174d' },
  { initial: 'S', bg: '#dcfce7', fg: '#166534' },
  { initial: 'R', bg: '#fef9c3', fg: '#854d0e' },
  { initial: 'A', bg: '#ede9fe', fg: '#5b21b6' },
]

function AvatarGroup() {
  return (
    <span className="inline-flex items-center align-middle mx-1.5" style={{ gap: '-4px' }}>
      {AVATARS.map((a, i) => (
        <span
          key={i}
          className="inline-flex items-center justify-center w-9 h-9 rounded-full border-2 border-white text-xs font-black"
          style={{
            background: a.bg,
            color: a.fg,
            marginLeft: i === 0 ? 0 : -10,
      ...
      <section className="bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 pt-16 pb-20">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              <h1
                className="font-black text-slate-900 leading-[0.95] tracking-[-0.04em]"
