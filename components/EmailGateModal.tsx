        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] focus:border-transparent transition"
            />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-[#7c3aed] text-white text-sm font-semibold rounded-xl hover:bg-[#5b21b6] transition-colors shadow-sm disabled:opacity-60"
          >
