      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="relative h-44 overflow-hidden bg-slate-100 select-none">
          {previewDataUrl ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-[#ede9fe] to-slate-100" />
          )}
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-3 mb-5">
            <button
              ...
              className={`rounded-xl border-2 p-4 text-left transition-all ${
                plan === 'monthly' ? 'border-[#7c3aed] bg-[#ede9fe]' : 'border-slate-200 hover:border-slate-300'
              }`}
            >
            ...
            <button
              ...
              className={`rounded-xl border-2 p-4 text-left relative transition-all ${
                plan === 'yearly' ? 'border-[#7c3aed] bg-[#ede9fe]' : 'border-slate-200 hover:border-slate-300'
              }`}
            >
          ...
          <a
            ...
            className="block w-full text-center py-3.5 bg-[#7c3aed] hover:bg-[#5b21b6] text-white font-bold rounded-xl transition-colors shadow-md text-sm"
          >
            Unlock & Download →
          </a>
