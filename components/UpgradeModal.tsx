    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
        ...
        <div className="text-center mb-6">
          <div className="w-12 h-12 rounded-2xl bg-[#ddd6fe] flex items-center justify-center mx-auto mb-4">
        ...
        <a
          href={CHECKOUT_URL}
          className="flex items-center justify-between w-full px-5 py-4 bg-[#7c3aed] hover:bg-[#5b21b6] text-white rounded-xl transition-colors mb-3"
        >
          <span className="font-semibold">Upgrade to Pro</span>
          <div className="text-right">
            <p className="font-bold text-sm">12€/month</p>
            <p className="text-xs text-[#c4b5fd]">or 99€/year</p>
          </div>
        </a>
