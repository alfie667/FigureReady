  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 flex flex-col items-center text-center">
        <div className="w-14 h-14 rounded-2xl bg-[#2563eb] flex items-center justify-center mb-5 shrink-0">
        ...
        <button
          onClick={dismiss}
          className="w-full py-3 px-6 bg-[#2563eb] hover:bg-[#1d4ed8] text-white text-sm font-semibold rounded-xl transition-colors"
        >
          Start Exploring
        </button>
