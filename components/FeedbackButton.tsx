  ...
  return (
    <>
      <button
        ...
        className="hidden md:flex fixed bottom-6 right-6 z-40 items-center gap-2 px-4 py-2.5 bg-white border border-slate-200 rounded-full shadow-lg text-sm font-medium text-slate-700 hover:bg-slate-50 hover:shadow-xl transition-all"
      >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#2563eb]"
                  />
                </div>
                <button
                  onClick={submit}
                  disabled={!form.liked && !form.frustrated && !form.missing}
                  className="w-full mt-2 py-2.5 bg-[#2563eb] hover:bg-[#1d4ed8] disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-semibold rounded-xl transition-colors"
                >
                  Submit Feedback
                </button>
              </div>
  ...
  return (
    <div>
      ...
      <textarea
        ...
        className="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm text-slate-700 resize-none focus:outline-none focus:ring-2 focus:ring-[#2563eb]"
      />
    </div>
  )
}
