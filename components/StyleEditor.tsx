    ...
    <div className="space-y-1.5">
      <div className="flex items-center justify-between">
        ...
        <input
          ...
          className="w-14 border border-slate-200 rounded-lg px-2 py-0.5 text-xs text-slate-700 text-center focus:outline-none focus:ring-1 focus:ring-[#7c3aed]"
        />
      </div>
  ...
  return (
    <div className="min-w-0">
      ...
      <select
        ...
        className="w-full border border-slate-200 rounded-lg px-2 py-1.5 text-xs text-slate-700 bg-white focus:outline-none focus:ring-1 focus:ring-[#7c3aed]"
      >
        {options.map(opt => (
    ...
    <div className="min-w-0 space-y-1.5">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="w-full min-w-0 border border-slate-200 rounded-lg px-2 py-1.5 text-xs text-slate-700 focus:outline-none focus:ring-1 focus:ring-[#7c3aed]"
        />
